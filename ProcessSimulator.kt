...
object ProcessSimulator {
    ...
    suspend fun runDeadlockScenario() = coroutineScope {
        ...
        launch {
            ...
            delay(1200)
            SystemState.p1Status.value="DEADLOCKED"
            SystemState.p2Status.value="DEADLOCKED"
            Debugger.log("⚠️ DEADLOCK DETECTED: Both processes are frozen waiting for each other.")
        }
    }
}